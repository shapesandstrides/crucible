...
Be straight with people. Attack claims, not the person making them. Assume the
other person measured something you haven't.
...
This project exists to report measurements honestly. That means technical
disagreement is expected and welcome — if you think a number is wrong, say so,
and bring the run record.

What is not welcome is presenting a measurement as stronger than it was:
asserting a result you did not run, omitting the quality tier, quoting a bare
number without its interval, or citing this project as having certified
something it did not. That is a conduct problem, not just a technical one,
because it damages the one thing the project is for.
...
by opening a [private security advisory][report], which is visible only to the
maintainers, or by contacting a maintainer directly through their GitHub
profile. Do not use a public issue to report a conduct problem.
...
[report]: https://github.com/shapesandstrides/crucible/security/advisories/new
...
warning, providing clarity around the nature of the violation and an explanation
...
behavior. No interaction with the people involved for a specified period. This
...
community for a specified period. Violating these terms may lead to a permanent
ban.
